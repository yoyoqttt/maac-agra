...
import Banner from '../components/Multimedia/Banner/Banner';
import Values from '../components/Multimedia/Values/Values';
import Services from '../components/Multimedia/Services/Services';
import Courses from '../components/Multimedia/Courses/Courses';
...
const  Multimedia = () => {
 ...
 <div className="gsap-fade-in" data-delay="0.1">
   ...
   <Services/>
        ...
        <div className="gsap-fade-in" data-delay="0.1"><Banner/></div>
...
export default Multimedia ;// src/pages/HomePage.jsx
